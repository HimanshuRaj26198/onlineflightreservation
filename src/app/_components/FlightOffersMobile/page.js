...
const FlightOfferCardMobile = ({ airlinesData, setActiveFlight, handleStopFilter }) => {
            ...
            <div className="listing-matrix-section slick-slider dealCntr dealSlider slick-initialized">
                <div className="tab-content">
                    <div
                        ...
                        id="airlineMatrix"
                    >
                        <div className="airline-matrix-mobile visible-xs">
                            <input
                                type="hidden"
                                id="isMixAvailable"
                                defaultValue="True"
...
export default FlightOfferCardMobile