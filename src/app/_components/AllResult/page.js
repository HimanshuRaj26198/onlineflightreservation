...
import PriceDetailsCard from '@/app/_components/PriceDetailsCard/page';

const ShortedFlightCard = ({ flight }) => {

    const [showDetails, setShowDetails] = useState(false);

    const HandlePriceDetails = () => {
        setShowDetails(!showDetails); // Toggle the visibility of the details component
    };
                        ...
                        <div className="row">
                            <div className="col-sm-3 col-xs-12 no-padding-left">
                                ...
                                <div className="airline-detail">
                                    <img src={flight.logo} onError={(e) => e.target.src = 'fallback-image.png'} alt={`${flight.airline} logo`} />
                                    <div className="name">
                                        {flight.airline}
                                    </div>
                                </div>
                            ...
                            <div className="col-sm-7 col-xs-12">
                                <div className="flex-date ">{flight.departureDate}</div>
                                <div className="leg-details">
                                    <div className="city text-right">
                                        <div className="time"><strong>{flight.departureTime}</strong></div>
                                        <div className="code">
                                            <span className="highlight tooltip-custom minor-txt">
                                                {flight.departureCode}
                                                <div className="promo-detail">
                                                    <span className="arrow" />
                                                    <p className="mb5px" style={{ textAlign: "left" }}>{flight.departureCity}</p>
                                                </div>
                                            </span>
                                        </div>
                                    </div>
                                ...
                                <div className="connnecting-block">
                                    <div className="leg-points">
                                        <div className="tooltip-custom">
                                            <span style={{ width: "auto" }} className="fa fa-clock-o" /> {flight.duration}
                                            <div className="promo-detail">
                                ...
                                <div className="leg-details">
                                    <div className="city">
                                        <div className="time"><strong>{flight.arrivalTime}</strong></div>
                                        <div className="code">
                                            <span className="highlight tooltip-custom minor-txt">
                                                {flight.arrivalCode}
                                                <div className="promo-detail">
                                                    <span className="arrow" />
                                                    <p className="mb5px" style={{ textAlign: "left" }}>{flight.arrivalCity}</p>
                                                </div>
                                            </span>
                                        </div>
                                    </div>
                ...
                <div className="price-section">
                    <price>
                        ...
                        <div className="per-person">
                            (Total price)
                            <button className="seedetail" onClick={HandlePriceDetails}>Select</button>
                        </div>
                        {/* Based on condition this Componenet will render  */}
                        {showDetails && (
                            <div style={{ display: 'flex', flexDirection: 'row' }}>
                                <PriceDetailsCard onClose={handleCloseDetails} />
                            </div>
                        )}
                    </price>
