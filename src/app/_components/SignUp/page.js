...
const SignUpComponent = ({ hideSignUp, showSignIn }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const userCredential = await createUserWithEmailAndPassword(emailRef.current.value, password);
                        ...
                        <div className="inner" bis_skin_checked={1}>
                            <div className="loginBox" bis_skin_checked={1}>
                                ...
                                <div className="right" bis_skin_checked={1}>
                                    ...
                                    <div onClick={handleGoogleSignIn} className="g-signin2" id="gsigup" bis_skin_checked={1}>
                                        Google
                                    </div>
