        ...
        <>
            <div class="body-content">
                <div class="information_popup hidden-xs" style={{ display: "none" }}>
                    <a href="javascript:void(0);" class="information_close-popup">
                        &times;
                    </a>
                    ...
                    <h3>Sun Country Airlines Reservation</h3>
                    <ul>
                        <li>
                        ...
                        <li>
                            <span class="number">2.</span>We do not use your personal
                            information for any promotional activity.
                        </li>
                    </ul>
                </div>
          ...
          if (pgurl != null && pgurl.toLowerCase().indexOf('home') > 0) {
                ...
                <div class="main-engine-wrapper ">
                    <div class="container hidden-xs">
                        ...
                        >
                            ...
                            >
                                Sun Country Airline Reservations Online
                            </h1>
                            <span
                                style={{
                                    fontSize: "16px",
                            ...
                            >
                                Search and Compare our best deals with over 550+ - Book
                                now!
                            </span>
                        </div>
                    </div>
                        ...
                        <div class="container">
                            ...
                            <div class="common_searchCntr">
                                ...
                                <section id="carEngineId" style={{ display: "none" }}>
                                    <Script dangerouslySetInnerHTML={`var carsearchAction = '/us/cars/searching';`} />
                                    <form id="CarForm">
                                                                ...
                                                                <div class="col-sm-5">
                                                                    ...
                                                                    >
                                                                        ...
                                                                        <div class="promo-detail">
                                                                            ...
                                                                            <p class="m-0">
                                                                                Additional Fee may apply for driver
                                                                                under 30 Yrs or above 65 Yrs old, at the
                                                                                time of rental. Please check term and
                                            ...
                                            <div class="outer">
                                                <div class="sucesspopupmsg">
                                                    ...
                                                    <p>
                                                        ...
                                                        Contact You Shortly. For More Information, You Can
                                                        Call Us At
                                                    </p>
              ...
              `}
                            ...
                            <div class="holder">
                                ...
                                <div class="column">
                                    <a href="/assets/best_price.html" target="_blank">
                                        ...
                                        <p>
                                            Found a lower fare, we will <br /> reimburse the
                                            difference.
                                        </p>
                                    </a>
                                </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3 col-sm-6 col-xs-12">
                                <div class="customer__block">
                                    ...
                                    <p>
                                        If you're able to find a lower flight fare on another
                                        website, make the claim within 24 hours of making the
                                        booking.{" "}
                                    </p>
                                    <a href="/assets/best_price.html" target="_blank">
                                        Read more
                            ...
                            <div class="col-md-3 col-sm-6 col-xs-12">
                                <div class="customer__block">
                                    ...
                                    <h3>Quick &amp; Easy</h3>
                                    <p>
                                        We make the whole booking process quick and easy. With just
                                        a few clicks, you can book your preferred flights and hotels
                                        at affordable rates.
                                    </p>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-12">
                                ...
                                <div class="leftCol">
                                    ...
                                    <div class="dealbox__note">
                                        ...
                                        , the fares mentioned above are for flight tickets and
                ...
                <section class="trustpilot-wraper" id="tpReview">
                    <div class="trustpilot-content">
                        <div class="container">
                                    ...
                                    <div class="title">
                                        <div class="row">
                                            <div class="col-sm-6">
                                                ...
                                                <h4>
                                                    <span class="trust-score">4.5/5</span>
                                                    <a
                                                        class="review_link"
                                                        href="#"
                                                        target="_blank"
                                            ...
                                            <div class="col-sm-6">
                                                <div class="right">
                                                    <img src="/assets/images/trustpilot/trust-pilot.png" />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <Slider {...secondSetting} className="tp-home-slider" >
                                <div class="review-block">
                                    <div class="review-content">
                                        ...
                                        <div class="clearfix"></div>
                                        <div class="name">Lidiia</div>
                                        <input
                                            type="hidden"
                                            id="66c77011c00e1510218f9892"
                                            value="Очень удобно"
                                        />
                                        <p class="txt">Очень удобно</p>
                                    </div>
                                </div>
                                <div class="review-block">
                                    <div class="review-content">
                                        ...
                                        />
                                        <p class="txt">
                                            Wade assisted me with my itinerary for my trip, which
                                            <a
                                                data-toggle="modal"
                                                data-target="#tpmyModal66c74c2d0abcdbabb7a4c9ba"
                                                class="read-more"
                                            >
                                                {" "}
                                                Read more
                                ...
                                <div class="review-block">
                                    <div class="review-content">
                                        ...
                                        />
                                        <p class="txt">
                                            The company was reliable and customer service is on top
                                            <a
                                                data-toggle="modal"
                                                data-target="#tpmyModal66c335abd66575b90d1e23b6"
                                                class="read-more"
                                            >
                                                {" "}
                                                Read more
                                ...
                                <div class="review-block">
                                    <div class="review-content">
                                        ...
                                        <p class="txt">
                                            ...
                                            <a
                                                data-toggle="modal"
                                                data-target="#tpmyModal66bfe502ea5401c0b99a6c98"
                                                class="read-more"
                                            >
                                                {" "}
                                                Read more
                                ...
                                <div class="review-block">
                                    <div class="review-content">
                                        ...
                                        />
                                        <p class="txt">
                                            The experience was quite good as i was easily able
                                            <a
                                                data-toggle="modal"
                                                data-target="#tpmyModal66be88ccb375e7b3a4bd4a54"
                                                class="read-more"
                                            >
                                                {" "}
                                                Read more
                                ...
                                <div class="review-block">
                                    <div class="review-content">
                                        ...
                                        <div class="clearfix"></div>
                                        <div class="name">Azka Elpabi Bius Sarma</div>
                                        <input
                                            type="hidden"
                                            id="66bab6d12d68ba6fb21676f4"
                                            value="The easy service to get a ticket"
                                        />
                                        <p class="txt">The easy service to get a ticket</p>
                                    </div>
                                </div>
                                <div class="review-block">
                                    <div class="review-content">
                                        ...
                                        />
                                        <p class="txt">
                                            I want to thank your Agent Selvin Brad for the
                                            <a
                                                data-toggle="modal"
                                                data-target="#tpmyModal66baa73709e776888a6d8952"
                                                class="read-more"
                                            >
                                                {" "}
                                                Read more
                                ...
                                <div class="review-block">
                                    <div class="review-content">
                                        ...
                                        <p class="txt">
                                            ...
                                            <a
                                                data-toggle="modal"
                                                data-target="#tpmyModal66b97bb8331a3580d20a1152"
                                                class="read-more"
                                            >
                                                {" "}
                                                Read more
                                ...
                                <div class="review-block">
                                    <div class="review-content">
                                        ...
                                        <div class="clearfix"></div>
                                        <div class="name">Reisha Osogreat</div>
                                        <input
                                            type="hidden"
                                            id="66b8dfea28623000d80f980b"
                                            value="Check them out"
                                        />
                                        <p class="txt">Convient and affordable</p>
                                    </div>
                                </div>
                                <div class="review-block">
                                    <div class="review-content">
                                        ...
                                        />
                                        <p class="txt">
                                            Easy to use system, found lower rates than all the
                                            <a
                                                data-toggle="modal"
                                                data-target="#tpmyModal66b7f398b1f9fd96605a93bb"
                                                class="read-more"
                                            >
                                                Read more
                                            </a>
                                ...
                                <div class="trustpilot-wraper">
                                    <div class="review-block">
                                        <div class="review-content">
                                            ...
                                            />
                                            <p class="txt">
                                                Wade assisted me with my itinerary for my trip, which I
                                                was very pleased. Great customer attention was given to
                                                me by this young man. He is a true asset to your
                                                company. Thank you, Darlene{" "}
                                            </p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="trustpilot-wraper">
                                    <div class="review-block">
                                        <div class="review-content">
                                            ...
                                            <p class="txt">
                                                The company was reliable and customer service is on top
                                                of the game with handling misunderstandings!
                                            </p>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="review-block">
                                        <div class="review-content">
                                            ...
                                            <p class="txt">
                                                ...
                                                support. Somehow I got in contact with a TourTravelHub
                                                ...
                                                it was from TourTravelHub and not JetBlue I got nervous and
                                                ...
                                                properly in the beginning of our conversation, that it
                                                ...
                                                I received my second email from TourTravelHub with more
                                                information like the flight confirmation code. Shortly
                                                after I received a call from TourTravelHub, a gentleman
                                                ...
                                                mother, so i want to make sure she’s comfortable in her
                                                ...
                                                taken care of by TourTravelHub representatives. What an
                                    ...
                                    <div class="review-block">
                                        <div class="review-content">
                                            ...
                                            <p class="txt">
                                                ...
                                                compare prizes for different dates, different airports
                                                and also different airlines. Must have a look here
                                                before booking{" "}
                                            </p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="review-block">
                                        <div class="review-content">
                                            ...
                                            <p class="txt">
                                                ...
                                                customer service he displayed. He went above and beyond
                                                to ensure that the mattter I queried was thorougly dealt
                                                with. He was able to give the best possible advise on
                                                the matter. I felt comforable and satisfied with the
                                                service. Well done Selvin!
                                            </p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="trustpilot-wraper">
                                    <div class="review-block">
                                        <div class="review-content">
                                            ...
                                            <p class="txt">
                                                I received excellent customer service from Scout! My
                                                questions were answered promptly and I was left
                                                satisfied. Definitely recommend booking with this
                                                company!{" "}
                                            </p>
                                        </div>
                                    </div>
                ...
                <div class="contentBox">
                    <div class="container">
                        ...
                        <p>
                            ...
                            or a business trip, book cheap air tickets with TourTravelHub and
                            save big on your ticket reservation.
                        </p>
                        <p>
                            Along with making travel affordable, we also believe in offering
                            unmatched user experience and customer service. Thanks to our
                            in-house technology team, we have developed our state-of-the-art
                            booking platform, through which travelers can scan hundreds of
                            flight deals and book the best-priced ticket in just a few clicks.
                            That is not all. When you book with us, you will also get to
                            experience our world-class 24/7 customer service, who will assist
                            you right from planning your travel to booking the lowest airfare
                            deals available online. What are you waiting for? Book online or
                            call us to fly with the cheapest flight tickets to your dream
                            destination.
                        </p>
                        <br />
                    </div>
...
export default SuncountryAirlines;
